...
var envDocs = []envDoc{
	...
	{Name: "OPEN_SURFACE_PYTHON", Group: "Plugin Runtime", Description: "Explicit Python interpreter for the optional open-surface browser transport.", Source: "browser transport"},
	{Name: "OPEN_SURFACE_ROOT", Group: "Plugin Runtime", Description: "Project root used to locate the open-surface virtual-environment interpreter.", Source: "browser transport"},
	{Name: "VIRTUAL_ENV", Group: "Plugin Runtime", Description: "Active Python virtual environment considered by the open-surface browser transport.", Source: "browser transport"},
